...
class MarkerDetector:
    ...
    def detect(self, image: np.ndarray) -> Dict[str, Optional[Tuple[int, int]]]:
        """Return centroids for red and blue markers if they are found."""
        return {
            "red": self._detect_single(image, "red", self.config.red_ranges),
            "blue": self._detect_single(image, "blue", self.config.blue_ranges),
        }
