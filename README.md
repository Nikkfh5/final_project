...
- Внешняя камера смотрит на рабочую область (пол), которая считается размеченной и лежащей в одной плоскости.
...
| 5  | Калибровка камеры и мировые координаты   | Выбор модели (гомография плоскости пола), сбор калибровочных точек на размеченном полу, вычисление матриц преобразования, проверка точности.                               | 10–12 часов      |
...
- реализация калибровки камеры и гомографии пола;
